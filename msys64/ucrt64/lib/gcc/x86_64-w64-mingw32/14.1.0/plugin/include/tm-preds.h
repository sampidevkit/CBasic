/* Generated automatically by the program 'C:\M\B\src\build-UCRT64\gcc\build\genpreds.exe'
   from the machine description file '../../gcc-14.1.0/gcc/config/i386/i386.md'.  */
